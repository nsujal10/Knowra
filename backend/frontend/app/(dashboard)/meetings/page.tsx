  ...
  return (
    <div className="w-full min-w-0 flex-1 overflow-x-hidden">
      ...
      <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-6">
        ...
        {/* ================================================================= */}
        <div className="w-full border border-[#d8d2f8] hover:border-[#5345dc]/40 rounded-2xl shadow-2xs flex items-center px-4 py-2.5 bg-white shrink-0 focus-within:ring-2 focus-within:ring-[#5345dc]/20 focus-within:border-[#5345dc] transition-all">
          {/* Left: Global / Workspace Selector */}
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-slate-200/80 bg-slate-50/70 text-[#5345dc] hover:bg-slate-100 cursor-pointer select-none shrink-0 transition-colors">
            <Globe className="w-4 h-4 text-[#5345dc]" />
          ...
          <button
            type="button"
            className="bg-slate-100/90 hover:bg-slate-200 text-slate-400 hover:text-slate-600 p-2 rounded-full transition-colors flex items-center justify-center ml-2 cursor-pointer shrink-0"
            title="Ask AI"
          >
        ...
        {/* ================================================================= */}
        <div className="flex items-center justify-between w-full shrink-0 pt-0.5">
          {/* Tabs Group (Left) */}
          <div className="flex items-center gap-2">
            <button
              ...
              className={`cursor-pointer transition-all px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 ${
                activeTab === "meetings"
                  ? "bg-[#f0edff] text-[#5345dc] border-b-2 border-[#5345dc]"
            ...
            <button
              ...
              className={`cursor-pointer transition-all px-4 py-2 rounded-lg text-sm flex items-center gap-2 ${
                activeTab === "processing"
                  ? "bg-[#f0edff] text-[#5345dc] border-b-2 border-[#5345dc] font-semibold"
                  : "bg-transparent text-slate-600 hover:text-slate-900 border-b-2 border-transparent font-medium"
              }`}
            >
          ...
          <div className="flex items-center gap-4">
            <div className="text-xs md:text-sm text-slate-500 flex items-center gap-1.5 select-none">
              <button
                type="button"
            ...
            <button
              ...
              className="bg-[#5345dc] hover:bg-[#4638cb] text-white flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm shadow-xs transition-colors cursor-pointer shrink-0"
            >
